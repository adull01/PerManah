...
<div class="breadcrumb-modern">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo e(route('anggota.dashboard')); ?>"><i class="fas fa-home me-1"></i>Dashboard</a></li>
            <li class="breadcrumb-item"><a href="<?php echo e(route('anggota.catalog')); ?>">Katalog</a></li>
            <li class="breadcrumb-item active"><?php echo e(Str::limit($book->title, 50)); ?></li>
        </ol>
    </nav>
</div>
            ...
            <div class="book-cover-wrapper">
                <div class="book-cover-shape">
                    <?php if($book->cover_image): ?>
                        <img src="<?php echo e(asset('storage/' . $book->cover_image)); ?>" class="book-cover-image" alt="<?php echo e($book->title); ?>" onerror="this.parentElement.innerHTML='<div class=\'book-cover-placeholder\'><i class=\'fas fa-book fa-8x\'></i></div>'">
                    <?php else: ?>
    ...
    <div class="col-md-8">
        <div class="book-info-card">
            <span class="book-id-badge">
                <i class="fas fa-hashtag"></i> ID: <?php echo e($book->id); ?>
            ...
            <div class="info-table">
                ...
                <div class="info-row">
                    ...
                    <div class="info-value"><?php echo e($book->stock); ?> Buku</div>
                </div>
                <div class="info-row">
                    ...
                    <div class="info-value">
                        <?php if($book->available > 0): ?>
                            <span class="badge-available">
                                <i class="fas fa-book me-1"></i><?php echo e($book->available); ?> Buku Tersedia
                            </span>
                        <?php else: ?>
            ...
            <div class="action-buttons">
                ...
                <?php endif; ?>
                <a href="<?php echo e(route('anggota.catalog')); ?>" class="btn-back">
...
<div class="modal fade" id="borrowModal" tabindex="-1">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content" style="border: none; border-radius: 16px; overflow: hidden;">
            <form action="<?php echo e(route('anggota.books.borrow', $book->id)); ?>" method="POST" id="borrowForm">
                <?php echo csrf_field(); ?>
                <!-- Modal Header -->
                ...
                <div class="modal-body" style="padding: 30px;">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            <div style="background: #f8fafc; padding: 16px; border-radius: 10px; border: 2px solid #e2e8f0;">
                                ...
                                <p class="mb-0 fw-bold" style="color: #1e293b; font-size: 1.1rem;"><?php echo e($book->id); ?></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div style="background: #f8fafc; padding: 16px; border-radius: 10px; border: 2px solid #e2e8f0;">
                                ...
                                <p class="mb-0 fw-bold" style="color: #1e293b; font-size: 1.1rem;"><?php echo e($book->isbn); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        <div style="background: #f8fafc; padding: 16px; border-radius: 10px; border: 2px solid #e2e8f0;">
                            ...
                            <p class="mb-0 fw-bold" style="color: #1e293b; font-size: 1.05rem;"><?php echo e($book->title); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            <div style="background: #f8fafc; padding: 16px; border-radius: 10px; border: 2px solid #e2e8f0;">
                                ...
                                <p class="mb-0 fw-bold" style="color: #1e293b;"><?php echo e($book->author); ?></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div style="background: #f8fafc; padding: 16px; border-radius: 10px; border: 2px solid #e2e8f0;">
...
<?php echo $__env->make('layouts.anggota', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\SKRIPSI\Project\resources\views/anggota/book-detail.blade.php ENDPATH**/ ?>