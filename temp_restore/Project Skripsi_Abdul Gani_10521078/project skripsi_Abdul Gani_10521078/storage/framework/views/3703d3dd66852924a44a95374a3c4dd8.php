        ...
        <table class="modern-table">
            ...
            <tbody>
                ...
                <tr class="<?php echo e($borrowing->status == 'pending' && $borrowing->notified_at ? 'highlight' : ''); ?> <?php echo e($borrowing->overdue_status == 'late' ? 'table-danger' : ''); ?>">
                    ...
                    <td>
                        <?php if($borrowing->overdue_status == 'late'): ?>
                    ...
                    <td>
                        ...
                        <?php if($lateFee > 0): ?>
                            <?php if($borrowing->is_fee_paid ?? false): ?>
                                <span class="badge bg-success" title="Lunas">Rp<?php echo e(number_format($lateFee, 0, ',', '.')); ?> (Lunas)</span>
                            <?php else: ?>
                                <span class="badge bg-danger" title="Belum Lunas">Rp<?php echo e(number_format($lateFee, 0, ',', '.')); ?></span>
                            <?php endif; ?>
                            <div class="mt-1">
                    ...
                    <td>
                        ...
                        <?php elseif($borrowing->status == 'approved'): ?>
                            <div class="action-buttons">
                                ...
                                <?php
                                    $feeTotal = ($borrowing->late_fee ?? 0) + ($borrowing->replacement_fee ?? 0);
                                ?>
                                        ...
                                        <form action="<?php echo e(route('petugas.borrowings.mark-lost', $borrowing->id)); ?>" method="POST">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" name="replacement_fee" class="form-control" placeholder="Biarkan kosong untuk menggunakan harga buku (<?php echo e(number_format($borrowing->book->price ?? 0,0,',','.')); ?>)">
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                                        ...
                                        <form action="<?php echo e(route('petugas.payments.store')); ?>" method="POST">
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" name="amount" class="form-control" value="<?php echo e(($borrowing->late_fee ?? 0) + ($borrowing->replacement_fee ?? 0)); ?>" required>
                                                </div>
                                                <div class="mb-3">
...
<?php echo $__env->make('layouts.petugas', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Skripsi\skripsi\resources\views/petugas/borrowings/index.blade.php ENDPATH**/ ?>