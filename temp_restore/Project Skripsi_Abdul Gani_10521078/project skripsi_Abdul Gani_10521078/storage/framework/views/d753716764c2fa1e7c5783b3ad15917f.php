...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="<?php echo e(route('admin.reports')); ?>" class="menu-item <?php echo e(request()->routeIs('admin.reports') ? 'active' : ''); ?>">
                <i class="fas fa-chart-bar"></i>
                <span>Laporan Peminjaman</span>
            </a>

            <a href="<?php echo e(route('admin.editProfile')); ?>" class="menu-item <?php echo e(request()->routeIs('admin.editProfile') ? 'active' : ''); ?>">
...
<?php /**PATH C:\Skripsi\skripsi\resources\views/layouts/admin.blade.php ENDPATH**/ ?>