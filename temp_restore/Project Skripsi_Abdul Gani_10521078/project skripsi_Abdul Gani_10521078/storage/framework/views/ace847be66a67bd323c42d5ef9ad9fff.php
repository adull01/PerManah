...
<body class="font-sans antialiased text-slate-600 login-bg min-h-screen flex items-center justify-center p-4">
    ...
    <div class="max-w-5xl w-full flex flex-col md:flex-row glass-card rounded-3xl overflow-hidden shadow-2xl border border-white/50">
        ...
        <div class="hidden md:flex md:w-1/2 bg-gradient-to-br from-brand-600 to-brand-800 p-12 text-white flex-col justify-between relative overflow-hidden">
            ...
            <div class="relative z-10">
                <a href="<?php echo e(route('landing')); ?>" class="flex items-center gap-2 mb-12 group">
                ...
                <div class="mb-8">
                    <div class="w-16 h-16 rounded-2xl bg-white shadow-xl flex items-center justify-center mb-6">
                        <img src="<?php echo e(asset('logo-MA.png')); ?>" alt="Logo MA" class="w-12 h-12 object-contain">
                    </div>
            ...
            <div class="relative z-10 pt-10 border-t border-white/10">
                <p class="text-xs font-semibold text-brand-200 uppercase tracking-widest text-center">© <?php echo e(date('Y')); ?> Ma Nurul Hikmah</p>
            </div>
        </div>
            ...
            <div class="max-w-md mx-auto h-full flex flex-col justify-center">
                ...
                <div class="md:hidden flex flex-col items-center mb-8">
                    <div class="w-14 h-14 rounded-2xl bg-white flex items-center justify-center mb-4 shadow-xl border border-slate-100">
                        <img src="<?php echo e(asset('logo-MA.png')); ?>" alt="Logo MA" class="w-10 h-10 object-contain">
                    </div>
                ...
                <div class="mt-10 pt-8 border-t border-slate-200 text-center">
                    ...
                    <a href="<?php echo e(route('anggota.register')); ?>" class="inline-block px-6 py-3 rounded-xl border-2 border-slate-200 text-slate-700 font-bold hover:bg-slate-50 hover:border-brand-300 hover:text-brand-600 transition-all">
                        Daftar Sebagai Anggota Baru
                    </a>
                </div>
                
                <div class="mt-6 md:hidden text-center">
                    <a href="<?php echo e(route('landing')); ?>" class="text-slate-500 font-bold text-sm hover:text-brand-600">
    ...
    <?php if(session('show_pending_modal')): ?>
    <script>
            ...
            Swal.fire({
                ...
                html: `
                    <div class="text-left space-y-4">
                        <p class="text-slate-600 leading-relaxed">Akun <strong><?php echo e(session('pending_email')); ?></strong> telah terdaftar dan saat ini sedang dalam <strong>tahap verifikasi</strong> oleh petugas kami.</p>
...
<?php /**PATH C:\Skripsi\skripsi\resources\views/auth/login.blade.php ENDPATH**/ ?>