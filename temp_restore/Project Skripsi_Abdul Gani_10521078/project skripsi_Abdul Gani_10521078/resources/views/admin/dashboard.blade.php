...
<div class="stats-grid">
    ...
    <div class="stat-card danger">
        <div class="stat-card-header">
            ...
            <div class="stat-trend {{ $pendingBorrowings > 0 ? 'up' : 'down' }}">
                <i class="fas fa-{{ $pendingBorrowings > 0 ? 'exclamation' : 'check' }}-circle"></i>
                <span>{{ $pendingBorrowings > 0 ? 'Pending' : 'Clear' }}</span>
            </div>
        </div>
