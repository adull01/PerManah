...
<body>
    ...
    <div class="stats">
        ...
        <div class="stat">
            ...
            <div>{{ number_format($borrowings->sum('late_fee') + $borrowings->sum('replacement_fee'), 0, ',', '.') }}</div>
        </div>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="center">{{ ucfirst($borrowing->status) }}</td>
                <td class="center">@php $fee = ($borrowing->late_fee ?? 0) + ($borrowing->replacement_fee ?? 0); @endphp {{ $fee > 0 ? number_format($fee,0,',','.') : '-' }}</td>
            </tr>
            @empty
            <tr>
