...
<div class="welcome-card">
    <h2><i class="fas fa-book-reader me-2"></i>Selamat Datang, {{ auth()->user()->name }}!</h2>
    ...
    <div class="info-card">
        ...
        <div class="info-card-body">
            <div style="display: flex; flex-direction: column; gap: 12px;">
                <a href="{{ route('anggota.catalog') }}" class="btn btn-action-dashboard">
                    <i class="fas fa-book"></i>
                    <span>Jelajahi Katalog Buku</span>
                </a>
                <a href="{{ route('anggota.history') }}" style="background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%); box-shadow: 0 8px 20px rgba(59, 130, 246, 0.3);" class="btn btn-action-dashboard">
                    <i class="fas fa-history"></i>
