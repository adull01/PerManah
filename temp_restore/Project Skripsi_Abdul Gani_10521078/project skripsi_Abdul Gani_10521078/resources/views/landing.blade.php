...
<body class="font-sans antialiased text-slate-600 bg-white scroll-smooth selection:bg-brand-500 selection:text-white">
    ...
    <section id="beranda" class="relative overflow-hidden">
        ...
        <div class="absolute top-0 inset-x-0 h-[550px] z-0">
            <img src="{{ asset('images/bg.jpeg') }}" class="w-full h-full object-cover object-center" alt="Library Background">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-30 pt-32 pb-20 text-center">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4 fade-in-up delay-300 mb-12">
                <a href="{{ route('login') }}" class="px-8 py-4 rounded-xl bg-brand-600 text-white font-bold text-lg hover:bg-brand-700 transition-all shadow-xl shadow-brand-500/20 hover:shadow-brand-500/40 hover:-translate-y-1">
            ...
            <div class="mt-20 relative mx-auto max-w-5xl fade-in-up delay-300">
                <div class="p-2 bg-slate-100 rounded-2xl shadow-2xl border border-slate-200/60">
                    <div class="bg-white rounded-xl overflow-hidden relative group">
                        ...
                        <img src="{{ asset('images/dashboard-preview.png') }}" alt="Dashboard Preview" class="w-full h-auto block relative z-10 transition-transform duration-500 group-hover:scale-[1.02]">
                    </div>
                </div>
            </div>
        </div>        
            ...
            <div class="mt-24 fade-in-up delay-300">
                ...
                <div class="relative w-full overflow-hidden group">
                    ...
                    <div class="flex gap-6 animate-scroll hover:pause-scroll w-[max-content]">
                        ...
                        <div class="w-32 md:w-40 flex-shrink-0 transition-transform duration-300 hover:scale-105 hover:-translate-y-2 cursor-pointer group/book" title="{{ $book->title }}">
                            <div class="aspect-[2/3] rounded-lg shadow-md overflow-hidden bg-white border border-slate-200 relative text-left">
                                ...
                                <div class="absolute inset-0 bg-black/60 opacity-0 group-hover/book:opacity-100 transition-opacity flex items-center justify-center p-2">
                                    <p class="text-white text-xs font-semibold text-center line-clamp-3">{{ $book->title }}</p>
                                </div>
                            </div>
                        </div>
                        @endforeach
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="p-8 rounded-2xl bg-slate-50 border border-slate-100 hover:shadow-lg transition-all group">
                    ...
                    <h3 class="text-4xl font-extrabold text-slate-900 mb-1">{{ $totalBooks }}+</h3>
                ...
                <div class="p-8 rounded-2xl bg-slate-50 border border-slate-100 hover:shadow-lg transition-all group">
                    ...
                    <h3 class="text-4xl font-extrabold text-slate-900 mb-1">{{ $totalMembers }}+</h3>
                ...
                <div class="p-8 rounded-2xl bg-slate-50 border border-slate-100 hover:shadow-lg transition-all group">
                    ...
                    <h3 class="text-4xl font-extrabold text-slate-900 mb-1">{{ $monthlyBorrowings }}+</h3>
                ...
                <div class="w-full md:w-1/2">
                    <div class="relative">
                        ...
                        <div class="relative bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl p-10 text-white overflow-hidden shadow-2xl">
                            ...
                            <a href="{{ route('anggota.register') }}" class="block w-full text-center py-3 bg-white text-slate-900 font-bold rounded-xl hover:bg-slate-100 transition-colors">
                                Daftar Sebagai Anggota
                            </a>
                            <p class="text-center text-sm text-slate-400 mt-4">Sudah punya akun? <a href="{{ route('anggota.login') }}" class="text-brand-400 hover:text-white underline">Masuk disini</a></p>
                        </div>
                    </div>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        ...
                        <li><a href="{{ route('about') }}" class="text-slate-400 hover:text-brand-400 transition-colors">Tentang Kami</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="border-t border-slate-800 pt-8 text-center">
                <p class="text-slate-500 text-sm">
                    {{ date('Y') }} PerManah - Perpustakaan MA Nurul Hikmah.
                </p>
            </div>
        </div>
    </footer>
    ...
    <script>
        ...
        menu.innerHTML = `
            <a href="{{ route('landing') }}#beranda" class="text-xl font-bold text-slate-900" onclick="closeMenu()">Beranda</a>
            <a href="{{ route('landing') }}#fitur" class="text-xl font-bold text-slate-900" onclick="closeMenu()">Fitur</a>
            <a href="{{ route('landing') }}#layanan" class="text-xl font-bold text-slate-900" onclick="closeMenu()">Layanan</a>
            <a href="{{ route('about') }}" class="text-xl font-bold text-slate-900" onclick="closeMenu()">Tentang Kami</a>
            <a href="{{ route('login') }}" class="px-6 py-3 rounded-xl bg-brand-600 text-white font-bold text-center">Login</a>
