...
<head>
    ...
    <title>@yield('title') - PerManah Member</title>
...
<body>
    ...
    <div class="sidebar">
        <div class="sidebar-header">
            <a href="{{ route('anggota.dashboard') }}" class="sidebar-brand">
        ...
        <div class="sidebar-menu">
            ...
            <a href="{{ route('anggota.catalog') }}" class="menu-item {{ request()->routeIs('anggota.catalog*') ? 'active' : '' }}">
                <i class="fas fa-book"></i>
                <span>Katalog Buku</span>
            </a>
            <a href="{{ route('anggota.history') }}" class="menu-item {{ request()->routeIs('anggota.history') ? 'active' : '' }}">
                <i class="fas fa-history"></i>
                <span>Riwayat Peminjaman</span>
            </a>
            <a href="{{ route('anggota.profile') }}" class="menu-item {{ request()->routeIs('anggota.profile*') ? 'active' : '' }}">
