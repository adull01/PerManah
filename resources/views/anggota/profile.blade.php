...
<div class="container-fluid px-4">
    ...
    <div class="profile-header">
        <div class="profile-photo-wrapper">
            <img src="{{ $user->profile_photo_url ?? asset('images/default-avatar.svg') }}" 
                 alt="Profile Photo" 
                 class="profile-photo"
                ...
                <form action="{{ route('anggota.profile.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nisn') is-invalid @enderror"
                               id="nisn" name="nisn" value="{{ old('nisn', $user->nisn) }}" maxlength="20" required>
                        @error('nisn')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
        ...
        <div class="col-md-4">
            <div class="profile-info-card">
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">{{ $user->nisn ?? '-' }}</div>
                </div>
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">{{ $user->borrowings()->count() }} buku</div>
                </div>

                <div class="info-item">
                    <div class="info-label">Peminjaman Aktif</div>
                    <div class="info-value">{{ $user->activeBorrowings()->count() }} buku</div>
                </div>
            </div>
