...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="{{ route('petugas.borrowings') }}" class="menu-item {{ request()->routeIs('petugas.borrowings*') ? 'active' : '' }}">
                <i class="fas fa-exchange-alt"></i>
                <span>Kelola Peminjaman</span>
            </a>

            <a href="{{ route('petugas.announcements') }}" class="menu-item {{ request()->routeIs('petugas.announcements*') ? 'active' : '' }}">
                <i class="fas fa-bullhorn"></i>
                <span>Kelola Pengumuman</span>
            </a>

            <a href="{{ route('petugas.extensions') }}" class="menu-item {{ request()->routeIs('petugas.extensions*') ? 'active' : '' }}">
                <i class="fas fa-calendar-plus"></i>
                <span>Perpanjangan</span>
            </a>

            <a href="{{ route('petugas.users') }}" class="menu-item {{ request()->routeIs('petugas.users*') ? 'active' : '' }}">
            ...
            <a href="{{ route('petugas.anggota.pending') }}" class="menu-item {{ request()->routeIs('petugas.anggota.pending*') ? 'active' : '' }}">
            ...
            <a href="{{ route('petugas.anggota.all') }}" class="menu-item {{ request()->routeIs('petugas.anggota.all*') ? 'active' : '' }}">
                <i class="fas fa-users text-success"></i>
                <span>Daftar Anggota</span>
            </a>

            <a href="{{ route('petugas.members') }}" class="menu-item {{ request()->routeIs('petugas.members*') ? 'active' : '' }}">
                <i class="fas fa-users"></i>
